...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor will construct the Silly object by the first name and the last name in a
     * format given by ["last name" "first name"].
     *
     * @param firstName the first name of the new Silly object.
     * @param lastName the last name of the new Silly object.
     */
